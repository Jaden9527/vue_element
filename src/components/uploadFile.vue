  ...
  <div v-show="uploadFileSetting.uploadShow">
    ...
    <div class="uploadLayer">
      <div class="uploadContent">
        <i class="el-icon-circle-close closeuploadBtn" @click="closeUploadLayer()"></i>
        <div class="warnTip">
        ...
        <div id="uploader-demo">
              ...
              <div :id="i" class="item" v-for="(file, i) in fileObj" :key="i">
                <h4 class="info">
                  ...
                  <span style="padding-left:10px">
                    <i class="el-icon-circle-close" @click="deleteFile(i)"></i>
                  </span>
                </h4>
              </div>
              <div class="item">
          ...
          <el-row>
            <el-col :span="12" style="text-align: center;">
              <el-button size="small" @click="chooseFn()">选择文件</el-button>
            </el-col>
            <el-col :span="12" style="text-align: center;">
              <el-button type="primary" size="small" @click="shangchuan()">开始上传</el-button>
            </el-col>
          </el-row>
        </div>
      </div>
  ...
  methods: {
    ...
    getFile: function(event) {
      ...
      if (this.fileObj.length >= this.uploadNum) {
        this.$message({
          showClose: true,
          message: "只能选择" + this.uploadNum + "个文件！",
          type: "warning"
        });
