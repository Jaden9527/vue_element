    ...
    children: [
      {
        ...
        name: 'home12',
        meta: { title: '首页12', icon: 'el-icon-s-management', roles: ['admin'],keepAlive: true }
      },
      {
        path: 'formDemo',
        component: () => import('@/components/custom-form/demo'),
        name: 'formDemo',
        meta: { title: '表单demo', icon: 'el-icon-s-promotion', roles: ['admin'],keepAlive: true }
      },
      {
        path: 'home13',
        component: () => import('@/views/dashboard/index'),
        name: 'home13',
        meta: { title: '首页124', icon: 'el-icon-s-promotion', roles: ['admin'],keepAlive: true }
      }
    ]
  },
